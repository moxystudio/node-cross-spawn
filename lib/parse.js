...
var needsShellRegExp = /\.(?:com|exe)$/i;
...
function parseNonShell(parsed) {
    ...
    if (shebang) {
        ...
        needsShell = hasEmptyArgumentBug || needsShellRegExp.test(resolveCommand(shebang) || resolveCommand(shebang, true));
    } else {
        needsShell = hasEmptyArgumentBug || needsShellRegExp.test(parsed.file);
    }
...
function parseShell(parsed) {
    ...
    // If node supports the `shell`, there's no need to mimic its behavior
